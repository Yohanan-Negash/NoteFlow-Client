    ...
    <div className='w-full'>
      ...
      {isNotebooksLoading ? (
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full'>
          {notebooks.length === 0 ? (
            <div className='col-span-full flex flex-col items-center justify-center py-24 text-foreground'>
      ...
      {showModal && (
        <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/30'>
          <div className='bg-primary rounded-xl shadow-xl p-8 w-full max-w-sm mx-4'>
            ...
            >
              ...
              <div className='flex gap-2 justify-end'>
                <button
                  type='button'
                  className='px-4 py-2 rounded-lg bg-gray-100 text-foreground hover:bg-gray-200'
                  onClick={() => {
                    setShowModal(false);
                    setError('');
                    setName('');
